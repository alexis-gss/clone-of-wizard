<?php
$title       = "Game";
$description = "Page of the platformer game named Clone of Wizard";
...
<body>
    <div class="game-wrapper">
        ...
        <a class="d-none btnMenu" href="./game.php">MENU</a>
        <button class="d-none btnEasyMode">EASY MODE</button>
    ...
    <img class="d-none imgSprite" src="./data/sprites/sprite-all.png" />
    <!-- BACKGROUNDS -->
    <img class="d-none fond1" src="./data/backgrounds/parallax-1.png" />
    <img class="d-none fond2" src="./data/backgrounds/parallax-2.png" />
    <img class="d-none fond3" src="./data/backgrounds/parallax-3.png" />
    <img class="d-none fond4" src="./data/backgrounds/death.png" />
    <img class="d-none fondMenu" src="./data/backgrounds/menu.png" />
    <!-- NOTES -->
    <img class="d-none annotation1" src="./data/notes/note-1.png" />
    <img class="d-none annotation2" src="./data/notes/note-2.png" />
    <img class="d-none annotation3" src="./data/notes/note-3.png" />
    <img class="d-none annotation4" src="./data/notes/note-4.png" />
    <img class="d-none annotation5" src="./data/notes/note-5.png" />
    <img class="d-none annotation6" src="./data/notes/note-6.png" />
    <!-- ITEMS -->
    <img class="d-none coeur" src="./data/items/heart.png" />
    <img class="d-none gemme" src="./data/items/gemstone.png" />
    <img class="d-none fireball" src="./data/items/fireball.png" />
    <!-- SOUNDS -->
    ...
    <!-- VOLUME -->
    <svg class="d-none volumeOn">
        <use class="iconUse1" href="#icon-volume-high"></use>
    </svg>
    <svg class="d-none volumeOff">
