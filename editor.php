<?php
$title       = "Map editor";
$description = "Editor map of the platformer game named Clone of Wizard";
...
<body>
    <section class="editor-wrapper">
        <div class="btns">
            <a class="btnMenu" href="./game.php">MENU</a>
            <a class="btnDelEditedMap">DELETE EDITED MAP</a>
            <a class="btnTester" href="./game.php">TEST</a>
        </div>
        <canvas></canvas>
        <div class="content">
            <div class="contentSelectionneur">
                ...
                <div class="menu">
                    ...
                    <img class="imgSprite" src="./data/sprites/editor-sprites.png" />
                </div>
            ...
            <div class="contentSelectionneur">
                ...
                <div class="menu">
                    ...
                    <img class="imgColl" src="./data/sprites/editor-collisions.png" />
                </div>
